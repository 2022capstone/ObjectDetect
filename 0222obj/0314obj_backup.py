...
def object_detection(url, cursor, testpython, name_list):
    # ! 필요한 파일 로드하기
    file_name = url
    ...
    # /Users/jongukyang/Desktop/hello.jpeg
    sql = "INSERT INTO carimg(id, imgurl, imgurl2, imgurl3) VALUES(15, '/Users/jongukyang/Desktop/" + save_dir + "', 'desktop/hello2', 'desktop/hello3');"
    cursor.execute(sql)
    testpython.commit()
        ...
        if rent_id == result['id']:
            ...
            for key, values in result.items():
                ...
                if values != str(values):
                    ...
                    object_detection(url, cursor, testpython, name_list[count])
                    count+1
    count = 0
