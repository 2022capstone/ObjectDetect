...
def update_data(rent_ids_lists, rent_id_data):
    project_car = pymysql.connect(
        host='localhost',
        port=3306,
        user='root',
    ...
    for data in rent_id_data:
        ...
        for key, values in data.items():
            if a < 1:
                # print("items :", a, key, values)
                a = a + 1
                continue
            else:
                print("items :", a, key, values)
                save_dir_img = obj_detect(values, a)
                print("sava_dir_img : ", save_dir_img)
                sql = "update rent_compare_img set " + db_column[a] + " = '"+ save_dir_img + "' where Rent_rent_id = " + str(r_id) + ";"
                print(sql)
                cursor.execute(sql)
                project_car.commit()
                a = a+1
    ...
    # sql = "UPDATE rent_compare_img " \
    #       "SET before_front = '/Users/jongukyang/Capstone-Obj/dmig/1.jpeg', " \
    #       "before_back = '/Users/jongukyang/Capstone-Obj/dmig/2.jpeg', " \
    #       "before_drive_front = '/Users/jongukyang/Capstone-Obj/dmig/3.jpeg', " \
    #       "before_drive_back = '/Users/jongukyang/Capstone-Obj/dmig/4.jpeg', " \
    #       "before_passenger_front = '/Users/jongukyang/Capstone-Obj/dmig/5.jpeg', " \
    #       "before_passenger_back = '/Users/jongukyang/Capstone-Obj/dmig/6.jpeg', " \
    #       "after_front = '/Users/jongukyang/Capstone-Obj/dmig/7.jpeg', " \
    #       "after_back = '/Users/jongukyang/Capstone-Obj/dmig/8.jpeg', " \
    #       "after_drive_front = '/Users/jongukyang/Capstone-Obj/dmig/9.jpeg', " \
    #       "after_drive_back = '/Users/jongukyang/Capstone-Obj/dmig/10.jpeg', " \
    #       "after_passenger_front = '/Users/jongukyang/Capstone-Obj/dmig/11.jpeg', " \
    #       "after_passenger_back = '/Users/jongukyang/Capstone-Obj/dmig/12.jpeg' " \
    #       "WHERE Rent_rent_id = " + str(r_id) + ";"
...
def obj_detect(values, a):
    ...
    name_lists = ["", "d_before_front.jpg", "d_before_back.jpg", "d_before_drive_front.jpg", "d_before_drive_back.jpg",
                  "d_before_passenger_front.jpg", "d_before_passenger_back.jpg", "d_after_front.jpg",
                  "d_after_back.jpg",
    ...
    save_dir_img = obj_detect_dir_path + name_lists[a]
...
def update_data2(rent_ids_lists, rent_id_data):
    project_car = pymysql.connect(
        host='localhost',
        port=3306,
        user='root',
