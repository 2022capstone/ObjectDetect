...
def update_data(rent_id_data):
    ...
    #       "SET before_front = '" + obj_detect_dir_path + name_lists[1] + "', " \
    #                                                                      "before_back = '" + obj_detect_dir_path + \
    #       name_lists[2] + "', " \
    #                       "before_drive_front = '" + obj_detect_dir_path + name_lists[3] + "', " \
    #                                                                                        "before_drive_back = '" + obj_detect_dir_path + \
    #       name_lists[4] + "', " \
    #                       "before_passenger_front = '" + obj_detect_dir_path + name_lists[5] + "', " \
    #                                                                                            "before_passenger_back = '" + obj_detect_dir_path + \
    #       name_lists[6] + "', " \
    #                       "after_front = '" + obj_detect_dir_path + name_lists[7] + "', " \
    #                                                                                 "after_back = '" + obj_detect_dir_path + \
    #       name_lists[8] + "', " \
    #                       "after_drive_front = '" + obj_detect_dir_path + name_lists[9] + "', " \
    #                                                                                       "after_drive_back = '" + obj_detect_dir_path + \
    #       name_lists[10] + "', " \
    #                        "after_passenger_front = '" + obj_detect_dir_path + name_lists[11] + "', " \
    #                                                                                             "after_passenger_back = '" + obj_detect_dir_path + \
    #       name_lists[12] + "' " \
    #                        "WHERE Rent_rent_id = " + str(last_rent_id) + ";"
